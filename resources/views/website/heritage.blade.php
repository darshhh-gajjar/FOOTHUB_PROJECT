...
@section('title', 'Heritage Collection - FILA India')
...
<div class="container-fluid px-lg-5 py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent p-0 mb-4">
            ...
            <li class="breadcrumb-item active text-dark fw-bold" aria-current="page">Heritage</li>
        </ol>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 d-none d-lg-block pe-5">
            ...
            <div class="mb-4">
                <h6 class="fw-bold text-uppercase mb-3 small">Era</h6>
                <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="era1">
                    <label class="form-check-label small text-muted" for="era1">70s</label>
                </div>
                <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="era2">
                    <label class="form-check-label small text-muted" for="era2">80s</label>
                </div>
                 <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="era3">
                    <label class="form-check-label small text-muted" for="era3">90s</label>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="form-check mb-2">
                    ...
                    <label class="form-check-label small text-muted" for="type1">Footwear</label>
                </div>
                <div class="form-check mb-2">
            ...
            <div class="mb-4">
                ...
                <div class="form-check mb-2">
                    ...
                    <label class="form-check-label small text-muted" for="price1">Under ₹ 5000</label>
                </div>
                <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="price2">
                    <label class="form-check-label small text-muted" for="price2">Above ₹ 5000</label>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-uppercase fw-bold text-navy mb-0">Heritage Collection</h2>
