...
@section('title', 'Men\'s Collection - FILA India')
...
<div class="container-fluid px-lg-5 py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent p-0 mb-4">
            ...
            <li class="breadcrumb-item active text-dark fw-bold" aria-current="page">Men</li>
        </ol>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-uppercase fw-bold text-navy mb-0">Men's Collection</h2>
