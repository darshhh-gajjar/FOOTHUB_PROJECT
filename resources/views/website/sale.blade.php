...
<div class="container-fluid px-lg-5 py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent p-0 mb-4">
            ...
            <li class="breadcrumb-item active text-danger fw-bold" aria-current="page">Sale</li>
        </ol>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 d-none d-lg-block pe-5">
            ...
            <div class="mb-4">
                ...
                <div class="form-check mb-2">
                    ...
                    <label class="form-check-label small text-muted" for="cat1">Men</label>
                </div>
                <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="cat2">
                    <label class="form-check-label small text-muted" for="cat2">Women</label>
                </div>
                 <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="cat3">
                    <label class="form-check-label small text-muted" for="cat3">Kids</label>
                </div>
            </div>

            <div class="mb-4">
                <h6 class="fw-bold text-uppercase mb-3 small">Discount</h6>
                <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="disc1">
                    <label class="form-check-label small text-muted" for="disc1">30% Off</label>
                </div>
                <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="disc2">
                    <label class="form-check-label small text-muted" for="disc2">50% Off</label>
                </div>
                 <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="disc3">
                    <label class="form-check-label small text-muted" for="disc3">70% Off</label>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="form-check mb-2">
                    ...
                    <label class="form-check-label small text-muted" for="price1">Under ₹ 3000</label>
                </div>
                <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="price2">
                    <label class="form-check-label small text-muted" for="price2">Above ₹ 3000</label>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-uppercase fw-bold text-danger mb-0">Sale</h2>
