...
@section('title', 'Women\'s Collection - FILA India')
...
<div class="container-fluid px-lg-5 py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent p-0 mb-4">
            ...
            <li class="breadcrumb-item active text-dark fw-bold" aria-current="page">Women</li>
        </ol>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 d-none d-lg-block pe-5">
            ...
            <div class="mb-4">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <button class="btn btn-outline-secondary btn-sm rounded-0" style="min-width: 40px;">UK 4</button>
                    <button class="btn btn-outline-secondary btn-sm rounded-0" style="min-width: 40px;">UK 5</button>
        ...
        <div class="col-lg-9">
             <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-uppercase fw-bold text-navy mb-0">Women's Collection</h2>
