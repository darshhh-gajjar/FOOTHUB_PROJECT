...
@section('title', 'Kids\' Collection - FILA India')
...
<div class="container-fluid px-lg-5 py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent p-0 mb-4">
            ...
            <li class="breadcrumb-item active text-dark fw-bold" aria-current="page">Kids</li>
        </ol>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 d-none d-lg-block pe-5">
            ...
            <div class="mb-4">
                <h6 class="fw-bold text-uppercase mb-3 small">Age</h6>
                 <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="age1">
                    <label class="form-check-label small text-muted" for="age1">2-4 Years</label>
                </div>
                <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="age2">
                    <label class="form-check-label small text-muted" for="age2">4-8 Years</label>
                </div>
                <div class="form-check mb-2">
                    <input class="form-check-input rounded-0" type="checkbox" id="age3">
                    <label class="form-check-label small text-muted" for="age3">8-12 Years</label>
                </div>
            </div>
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-uppercase fw-bold text-navy mb-0">Kids' Collection</h2>
